...
export const LinkedInIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M20.45 20.45h-3.55v-5.57c0-1.33-.02-3.04-1.85-3.04-1.86 0-2.14 1.45-2.14 2.95v5.66H9.34V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.36-1.85 3.6 0 4.27 2.37 4.27 5.45v6.3zM5.34 7.43c-1.14 0-2.07-.93-2.07-2.07 0-1.14.93-2.07 2.07-2.07s2.07.93 2.07 2.07c0 1.14-.93 2.07-2.07 2.07zM7.12 20.45H3.55V9h3.57v11.45zM22.23 0H1.77C.79 0 0 .78 0 1.75v20.5C0 23.22.79 24 1.77 24h20.46c.98 0 1.77-.78 1.77-1.75V1.75C24 .78 23.21 0 22.23 0z" />
    </svg>
  );
};
...
export const ArrowUp = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    className="w-6 h-6"
    fill="none"
    height={size || height}
...
export const ArrowDown = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    className="w-6 h-6 "
    fill="none"
    height={size || height}
...
export const CheckCircleIcon = ({ size = 24, className = "" }: IconSvgProps) => (
  <svg
    className={className}
    fill="none"
    height={size}
