      ...
      <NavbarContent className="basis-1/5 sm:basis-full gap-12" justify="start">
        <NavbarBrand as="li" className="gap-3 max-w-fit">
          <NextLink className="flex justify-start items-center gap-1" href="/">
            <h1 className="font-bold text-inherit text-2xl uppercase">
              sandrine alcazar
            </h1>
          </NextLink>
        </NavbarBrand>
      ...
      <>
        ...
        >
          <NavbarItem className="hidden sm:flex gap-4">
            ...
            >
              <LinkedInIcon className="text-default-500 header-links" />
            </Link>
            <Link isExternal aria-label="Github" href={siteConfig.links.github}>
              <GithubIcon className="text-default-500 header-links" />
            </Link>
            <ThemeSwitch />
          </NavbarItem>
        </NavbarContent>
